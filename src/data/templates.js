export const STORY_QUESTIONS = {
  '客質/客層': [
    ...
    { key: 'insight', label: '気づきおすすめ', placeholder: '他のお店と比べて違うなと思ったポイントは？\n（未経験なら「想像と違った点」でもOK）' },
  ],
  '給与/報酬/待遇': [
    ...
    { key: 'insight', label: '気づきおすすめ', placeholder: '報酬面で「これがいい」と感じたポイントは？\n例: 日払い、バック率、ロング率' },
  ],
  '人間関係': [
    { key: 'before', label: '入る前の気持ち', placeholder: 'スタッフとの関係で気になっていたことは？\n例: 距離感は？口うるさくない？' },
    { key: 'experience', label: '実際の体験', placeholder: '実際のスタッフドライバー女の子同士の雰囲気は？\n具体的な場面があると' },
    { key: 'insight', label: '気づきおすすめ', placeholder: '長く続けられそうと思った理由は？' },
  ],
  '通勤環境': [
    { key: 'before', label: '入る前の気持ち', placeholder: '通勤（アクセス）で心配だったことは？' },
    { key: 'experience', label: '実際の体験', placeholder: '実際の送迎立地アクセスはどうでしたか？' },
    { key: 'insight', label: '気づきおすすめ', placeholder: '出稼ぎ/通いとして便利だと感じたポイントは？' },
  ],
  '求人ページ信用度': [
    { key: 'before', label: '入る前の気持ち', placeholder: '求人ページを見た時、正直どう思いましたか？' },
    { key: 'experience', label: '実際の体験', placeholder: '実際に入ってみて、求人の内容と合ってましたか？' },
    { key: 'insight', label: '気づきおすすめ', placeholder: '「ここは本当だった」と思ったポイントは？' },
  ],
  '待機環境': [
    { key: 'before', label: '入る前の気持ち', placeholder: '待機って何するの？と思ってましたか？' },
    { key: 'experience', label: '実際の体験', placeholder: '待機室の実際の雰囲気設備はどうでしたか？' },
    { key: 'insight', label: '気づきおすすめ', placeholder: '待機中の過ごし方で気に入っているポイントは？' },
  ],
}
...
export const SHARE_TEMPLATE = () => 'OKINI蒲田のリアルな声\uD83C\uDF38 #OKINI蒲田 #高収入バイト'